            ...
            <div onClick={() => setIsStatusOpen(!isStatusOpen)} style={{ background: isDarkMode ? "rgba(255, 255, 255, 0.08)" : "rgba(14, 165, 233, 0.08)", borderRadius: 12, padding: "12px 16px", cursor: "pointer", transition: "all 0.3s ease", border: isDarkMode ? T.cardBorder : "1px solid rgba(14, 165, 233, 0.2)" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <p style={{ fontSize: 10, fontWeight: "800", color: isDarkMode ? T.textGray : "#000000", margin: 0, textTransform: "uppercase", letterSpacing: 0.5 }}>Kuota Cuti 2026</p>
                </div>
              ...
              {isStatusOpen && (
                <div style={{ marginTop: 12, paddingTop: 10, borderTop: `1px dashed ${isDarkMode ? "rgba(255, 255, 255, 0.15)" : "rgba(14, 165, 233, 0.2)"}`, display: "flex", flexDirection: "column", gap: 8 }}>
                  <div><p style={{ fontSize: 9, fontWeight: "800", color: isDarkMode ? T.textLight : "#000000", margin: "0 0 2px 0", textTransform: "uppercase" }}>Karyawan</p><p style={{ fontSize: 12, fontWeight: "700", color: isDarkMode ? T.textDark : "#000000", margin: 0 }}>{name}</p></div>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                    <div><p style={{ fontSize: 9, fontWeight: "800", color: isDarkMode ? T.textLight : "#000000", margin: "0 0 2px 0", textTransform: "uppercase" }}>Terpakai</p><p style={{ fontSize: 12, fontWeight: "800", color: isDarkMode ? T.textDark : "#000000", margin: 0 }}>{totalTerpakai} HARI</p></div>
                    <div><p style={{ fontSize: 9, fontWeight: "800", color: isDarkMode ? T.textLight : "#000000", margin: "0 0 2px 0", textTransform: "uppercase" }}>Sisa</p><p style={{ fontSize: 12, fontWeight: "800", color: isDarkMode ? T.textDark : "#000000", margin: 0 }}>{sisaCuti} HARI</p></div>
                  </div>
                </div>
              )}
            </div>
          ...
          <div className="sidebar-profile" style={{ marginTop: "auto", padding: "24px", borderTop: isDarkMode ? T.cardBorder : "1px solid rgba(14, 165, 233, 0.15)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <p style={{ fontSize: 11, fontWeight: "500", color: isDarkMode ? T.textGray : "#000000", margin: 0 }}>{pos}</p>
              </div>
            </div>
